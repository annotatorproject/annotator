...
QString Haarcascade::getName()
{
    return "Haarcascade";
}

QWidget *Haarcascade::getWidget()
{
    return &widget;
}
...
AnnotatorLib::Object *Haarcascade::getObject()
{
    return this->object;
}
...
std::vector<AnnotatorLib::Commands::Command *> Haarcascade::getCommands()
{
    ...
    try{
        ...
        cascade.detectMultiScale( frame_gray, objects, 1.1, 2, 0|CV_HAAR_SCALE_IMAGE, cv::Size(30, 30) );
        ...
        for( size_t i = 0; i < objects.size(); i++ )
        {
            ...
            AnnotatorLib::Commands::NewAnnotation * nA = new AnnotatorLib::Commands::NewAnnotation(name, frame, x + w*0.5, y + h*0.5
                                              , w*0.5, w*0.5, this->session, true);
