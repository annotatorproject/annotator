...
RemoveRangeDialog::RemoveRangeDialog(std::shared_ptr<AnnotatorLib::Project> project,
                                     std::shared_ptr<AnnotatorLib::Object> object,
                                     unsigned long currentFrame, QWidget *parent)
  ...
  try{
      ...
      ui->endFrameSpinBox->setMaximum(object->getLastAnnotation()->getFrame()->getFrameNumber());
      ui->endFrameSpinBox->setValue(object->getLastAnnotation()->getFrame()->getFrameNumber());
  } catch(...){
...
std::shared_ptr<AnnotatorLib::Commands::RemoveAnnotationRange> RemoveRangeDialog::getCommand()
{
    return shared_ptr<AnnotatorLib::Commands::RemoveAnnotationRange>(
                new AnnotatorLib::Commands::RemoveAnnotationRange(project->getSession(),
                                                                  object,
...
void RemoveRangeDialog::updateStartSliderMinMax() {
  ...
  ui->startFrameSpinBox->setMinimum(object->getFirstAnnotation()->getFrame()->getFrameNumber());
  ui->startFrameSlider->setMinimum(object->getFirstAnnotation()->getFrame()->getFrameNumber());
}

void RemoveRangeDialog::updateEndSliderMinMax() {

  ui->endFrameSlider->setMaximum(object->getLastAnnotation()->getFrame()->getFrameNumber());
  ui->endFrameSpinBox->setMaximum(object->getLastAnnotation()->getFrame()->getFrameNumber());
