...
void SelectedObject::updateImage()
{
    if (object && object->getFirstAnnotation()) {
       ui->commandLinkButtonFirst->setIcon(getImgCrop(object->getFirstAnnotation(), ui->commandLinkButtonFirst->height()));
    ...
    if (object && object->getLastAnnotation()) {
      ui->commandLinkButtonLast->setIcon(getImgCrop(object->getLastAnnotation(), ui->commandLinkButtonLast->height()));
...
void SelectedObject::resizeEvent(QResizeEvent* event)
{
  ...
  ui->commandLinkButtonFirst->setIconSize(QSize(ui->commandLinkButtonFirst->height(),
                                                ui->commandLinkButtonFirst->height()));
  ui->commandLinkButtonLast->setIconSize(QSize(ui->commandLinkButtonLast->height(),
...
{
  SelectionController::instance()->setSelectedFrame(object->getFirstAnnotation()->getFrame());
}

void SelectedObject::on_commandLinkButtonLast_clicked()
{
  SelectionController::instance()->setSelectedFrame(object->getLastAnnotation()->getFrame());
}
