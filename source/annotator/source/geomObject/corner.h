...
public:
    ...
    enum {MouseReleased=0, MouseDown, MouseMoving}; ///< define the mouse states
    qreal mouseDownX;
    qreal mouseDownY;
...
private:
    ...
    QColor cornerborderColor;           //< the hover event handlers will toggle this between red and black
    QPen cornerborderPen;               //< the pen is used to paint the red/black border

    qreal   cornerwidth;
    qreal   cornerheight;

    int corner;                         // 0,1,2,3  - starting at x=0,y=0 and moving clockwise around the box
