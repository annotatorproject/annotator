...
AnnotationItem::AnnotationItem(AnnotatorLib::Annotation *annotation, QWidget *parent) :
    QWidget(parent),
    ui(new Ui::AnnotationItem),
...
void AnnotationItem::reload()
{
    ...
    this->ui->objectNameLabel->setText(QString::fromStdString(this->annotation->getObject()->getName()));
    this->ui->frameSpinBox->setValue(this->annotation->getFrame()->getNumber());
    this->ui->positionLabel->setText(QString::number(this->annotation->getX()) + "x" + QString::number(this->annotation->getY()));
}
